...
if ($id == '' || $token == ''){
    ...
    if ($token == $token_tmp) {
        ...
        if ($sql->fetchColumn() > 0 ) {
            ...
            $rutaImg = $dir_images . 'principal1.jpg';
            ...
            if (file_exists($dir_images)){
                ...
                while(($archivo = $dir->read()) != false) {
                    if($archivo != 'principal1.jpg' && (strpos($archivo,'jpg') || strpos($archivo, 'jpeg'))){
        ...
        <div class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarHeader">
                    ...
                    <a href="/paginatienda/checkout.php" class="btn btn-primary">
